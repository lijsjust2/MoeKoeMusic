...
<body>
<h3 id="h3--"><a name="# 核心特性" class="reference-link"></a><span class="header-link octicon octicon-link"></span># 核心特性</h3><p>🚀 自动化构建：仅通过 GitHub Action 生成 Docker 镜像，无需本地编译<br>📱 移动端适配：界面优化适配手机等移动设备，操作更便捷<br>📥 下载功能：支持音乐下载，默认提供 128K 音质版本</p>
